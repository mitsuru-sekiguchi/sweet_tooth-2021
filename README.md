...
|投稿機能             |投稿をするため                        |
|                    |                                   |
|投稿詳細機能          |投稿の詳細を確認できるようにするため        |
|                    |                                   |
|投稿編集機能          |投稿の編集をできるようにするため           |
|                    |                                   |
|投稿削除機能          |投稿の削除をできるようにするため           |
|                    |                                   |
|投稿一覧機能          |ユーザーの投稿一覧を確認できるようにするため |
|                    |                                   |
|投稿コメント機能        |投稿にコメントできるようにするため           |
|                    |                                   |
|投稿検索機能          |投稿を検索できるようにするため            |
|                    |                                   |
|投稿Yummy!(いいね機能) |投稿に評価できるようにするため            |
