...
### ゲストログイン機能
----
![guest](https://user-images.githubusercontent.com/74820572/114174318-69c8fb00-9973-11eb-856d-e5c8cc321808.jpg)
<br>
...
### 地図検索機能
----
![googlemap](https://user-images.githubusercontent.com/74820572/115977108-c2250d00-a5af-11eb-84ae-8cd690a89d0a.jpg)
<br>
...
※ゲストログイン機能を実装しましたので左上「ゲストログイン（閲覧用）」よりクリックのみで簡単にログイン可能です。万が一出来ない場合はお手数ですが下記ログイン、パスワードをご入力ください。<br>
...
##### 登録しているユーザーはトップページの投稿一覧よりいいね（絵文字）をクリックすることにより評価することができる。また2度クリックすることで取り消すことも可能である。
----
<br>
<br>
...
### ゲストログイン機能
----
![guest](https://user-images.githubusercontent.com/74820572/114174896-45215300-9974-11eb-8f06-902b38be6b94.gif)
##### トップページ左上「ゲストログイン（閲覧用）」をクリックすると登録せずにワンクリックでログインが可能。投稿、投稿編集、投稿削除、投稿コメント、いいね（絵文字）など通常のユーザー同様の操作が可能である。
----
<br>
<br>
...
### 地図検索機能
----
![googlemap](https://user-images.githubusercontent.com/74820572/115977111-c6512a80-a5af-11eb-9c2c-86de2110b772.gif)
##### トップページより投稿をクリックし投稿詳細画面へ移動。投稿詳細画面の下部に検索用フォームと地図が表示してあり店名または住所を入力することで地図検索が可能である。
----
<br>
<br>
...
|-----|-----|-----|-----|-----|-----|
|3                        |ユーザー管理機能       |ユーザー登録をするため                  |ユーザー情報を入力し登録する。<br>登録したユーザーが登録したメールアドレス、パスワードのみでログインができる。|・ユーザー情報を登録していないと投稿、編集、削除、コメントができない<br>・ユーザー情報を登録していると投稿、編集、削除、コメントができる|8|
||                    |                                   |
...
||                    |                                   |
|1|ゲストログイン機能 |閲覧用として簡単にログインできるようにするため            |ゲストログイン（閲覧用）を押下するとログインできる|・ゲストログインしていないと投稿、編集、削除、コメントができない<br>・ゲストログインしていると投稿、編集、削除、コメントができる|1|
||                    |                                   |
|2|地図検索機能 |投稿で表示されている店舗を検索できるようにするため            |投稿の詳細ページより地図検索ができる|・ユーザー登録の有無に関わらず店舗を地図検索できる<br>|5|
